...
#endif
#ifndef OCALL_FILE_EXISTS_DEFINED__
#define OCALL_FILE_EXISTS_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_file_exists, (const char* filename, int* exists));
#endif
#ifndef OCALL_READ_FILE_DEFINED__
#define OCALL_READ_FILE_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_read_file, (const char* filename, char* buffer, size_t buffer_size, int* ret));
#endif
#ifndef OCALL_WRITE_FILE_DEFINED__
#define OCALL_WRITE_FILE_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_write_file, (const char* filename, const char* data, size_t data_size, int write_mode, int* ret));
#endif
